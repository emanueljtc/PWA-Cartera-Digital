...
<style lang="scss">
  ...
  .element-two {
    background-color: #c0d84a !important;
  }
  ...
  .element-four {
    background-color: #59ba70 !important;
  }

  .element-five {
   background-color: #af85bc !important;
  }

  .element-six {
    background-color: #fbbb2f !important;
  }

  .element-seven {
    background-color: #6179bb !important;
  }
  .close-modal {
    position: absolute;
    top: 0px;
